...
const Navbar = () => {
  ...
  const controNavbar = () => {
    if (window.scrollY > 200) {
      if (window.scrollY > lastScroll) {
        setShow("-translate-y-[100%]");
      } else {
        setShow("shadow shadow-[gray]/[0.2]");
      }
    } else {
  ...
  return (
    <header
      className={`header bg-white min-h-[100px] border-b-[0.5px] z-20 sticky top-0 transition-transform duration-300 ${show}`}
    >
      <div className="container mx-auto xl:max-w-[1200px] text-black flex items-center justify-between">
        <nav className="w-full">
          <div className="justify-between relative px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
            ...
            <div className="space-x-2 mb-2 md:mb-0 relative">
